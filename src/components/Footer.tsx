  ...
  return (
    <footer className="py-10 border-t border-border">
      <div className="max-w-[1200px] mx-auto px-10">
        <div className="flex flex-wrap items-center justify-between gap-5 max-sm:flex-col max-sm:text-center">
          <Link
            href="#hero"
          ...
          <div className="flex gap-3">
            {socials.map((s) => (
              <a
                ...
                aria-label={s.label}
                className="w-9 h-9 bg-surface border border-border rounded-lg flex items-center justify-center text-txt-2 no-underline text-[15px] transition-all duration-200 hover:bg-surface-2 hover:border-border-2 hover:-translate-y-0.5"
              >
                {s.icon}
              </a>
            ))}
          ...
          <span className="font-mono text-[11px] text-txt-3 tracking-[0.5px]">
