...
/>
              ...
              <div className="absolute -bottom-5 -right-5 px-6 py-4 bg-bg border border-border-2 rounded-2xl backdrop-blur-md max-lg:right-4">
                ...
                <div className="text-[12px] text-txt-3 mt-0.5">Projects completed</div>
              </div>
            </div>
          </Reveal>
          ...
          <Reveal delay={0.15}>
            ...
            >
              Building for the web,<br />obsessed with craft
            </h2>
            ...
            <div className="mt-6 space-y-4">
              ...
              <p className="text-[15px] text-txt-2 leading-[1.8] font-light">
                ...
                applications using the modern JavaScript ecosystem. My approach combines
                technical rigor with a deep focus on user experience.
              </p>
              <p className="text-[15px] text-txt-2 leading-[1.8] font-light">
                When I&apos;m not writing code, I&apos;m contributing to open source, writing
                about web performance, or exploring new tools that push the boundaries of
            ...
            <div className="grid grid-cols-2 gap-3 mt-8">
              {ABOUT_SKILLS.map((skill) => (
                <div key={skill} className="flex items-center gap-2 text-[14px] text-txt-2">
